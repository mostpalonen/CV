#include "toxicbullet.h"
#include <QPixmap>
#include <QTimer>
#include <qmath.h>
#include "mainwindow.h"

ToxicBullet::ToxicBullet(QGraphicsItem *parent) : Bullet(parent)
{
    // set bullet graphics
    setPixmap(QPixmap(":/images/toxicbullet.png"));
